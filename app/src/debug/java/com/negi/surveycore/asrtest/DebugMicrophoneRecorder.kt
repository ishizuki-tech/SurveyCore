...
/**
 * Debug-only 16 kHz mono PCM recorder used to validate the microphone-to-ASR path.
 */
class DebugMicrophoneRecorder(
    ...
    fun requestStop() {
        ...
        try {
            ...
            // The recorder may already have stopped while the UI is shutting down.
        }
    }
    ...
    fun recordBlocking(
        ...
        val readBuffer =
            ShortArray(
                bufferSizeBytes / BYTES_PER_SAMPLE
            )
        ...
        val maxSamples =
            sampleRateHz *
                maxDurationSeconds.coerceAtLeast(1)
        ...
        try {
            ...
            while (
                ...
                when {
                    ...
                    stopRequested -> break
                        ...
                        error(
                            "AudioRecord.read failed with code $readCount."
                        )
                }
            }
        } finally {
            try {
                ...
                // Ignore shutdown races in this debug recorder.
            }
    ...
    private class FloatSampleBuffer(
        ...
        private var values =
            FloatArray(
                initialCapacity.coerceAtLeast(1)
            )
    ...
    companion object {
        ...
        const val DEFAULT_MAX_DURATION_SECONDS =
            30

        private const val BYTES_PER_SAMPLE =
            2

        private const val PCM_16_SCALE =
            32_768.0f
    }
}
